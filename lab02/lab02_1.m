...
y_train = [repmat([0,1], amount, 1); repmat([1,1], amount, 1); repmat([1,0], amount, 1); repmat([0,0], amount, 1)]';
...
for i=1:1000
   if y_test1(i,1) == 0 &&  y_test1(i,2) == 1
        ok = ok + 1;
   end
   if y_test2(i,1) == 1 &&  y_test2(i,2) == 1
        ok = ok + 1;
   end
   if y_test3(i,1) == 1 &&  y_test3(i,2) == 0
        ok = ok + 1;
   end
   if y_test4(i,1) == 0 &&  y_test4(i,2) == 0
        ok = ok + 1;
   end
end
